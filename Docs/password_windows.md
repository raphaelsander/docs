...
Arquivo contendo os hashs de usuários **C:/windows/system32/config/SAM**.
...
``C:\> type 127.0.0.1.pwdump`` ==> Para visualizar o arquivo.  

### Quebrando hash Windows XP, Windows Server 2003 ou inferior
...
### Quebrando hash Windows Vista ou superior
...
Caminho padrão do WCE no Kali Linux é **/usr/share/wce/**.  
